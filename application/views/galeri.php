						...
						<div class="row g-5">
							...
							<div class="col-lg-4 border-start custom-border">
								...
								<div class="post-entry-1">
									<img src="<?= base_url('assets/upload/galeri/'.$kon['foto']) ?>" class="img-fluid img-galeri">
									<div class="post-meta"><span class="mx-1">&bullet;</span> <span><?= $kon['tanggal']?></span></div>
									<h2><a data-bs-toggle="modal" data-bs-target="#<?= $kon['foto']?>" href="<?= $kon['foto']?>"><?= $kon['judul']?></a></h2>
									<!-- Modal -->
											<div class="modal fade" id="<?= $kon['foto']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
											<div class="modal-dialog modal-lg">
												<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="exampleModalLabel"><?= $kon['judul']?></h5>
													<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
												</div>
												<div class="modal-body text-center">
													<img src="<?= base_url('assets/upload/galeri/'.$kon['foto'])?>" alt="">
												</div>
