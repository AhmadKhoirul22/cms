						...
						<div class="row g-5">
							...
							<div class="col-lg-4 border-start custom-border">
								...
								<div class="post-entry-1">
									<a href="<?= base_url('home/berita/'.$kon['slug'])?>"><img
											src="<?= base_url('assets/upload/konten/'.$kon['foto']) ?>" alt=""
											class="img-fluid img-galeri"></a>
									<div class="post-meta"><span class="date"><?= $kon['nama_kategori']?></span> <span
											class="mx-1">&bullet;</span> <span><?= $kon['tanggal']?></span></div>
							...
							<div class="col-lg-4">
								...
								<div class="trending">
									...
									<ul class="trending-post">
										<?php $no = 1;foreach($last_content as $content){?>
										<li>
											<a href="<?= base_url('home/berita/'.$content->slug)?>">
												<span class="number"><?= $no;?></span>
												<h3><?= $content->judul?></h3>
												<span class="author"><?= $content->nama_kategori?></span>
											</a>
										</li>
										<?php $no++; } ?>
									</ul>
              ...
              <li><a href="contact.html"><i class="bi bi-chevron-right"></i> Contact</a></li> -->
					...
					<div class="col-lg-4">
						...
						<ul class="footer-links footer-blog-entry list-unstyled">
							<?php foreach($last_content as $kay): ?>
							<li>
								<a href="<?= base_url('home/berita/'.$kay->slug)?>" class="d-flex align-items-center">
									<img src="<?= base_url('assets/upload/konten/'.$kay->foto)?>" alt="" class="img-fluid me-3">
									<div>
										<div class="post-meta d-block"><span class="date"><?= $kay->nama_kategori?></span> <span
												class="mx-1">&bullet;</span> <span><?= $kay->tanggal?></span></div>
										<span><?= $kay->judul?></span>
									</div>
								</a>
							</li>
